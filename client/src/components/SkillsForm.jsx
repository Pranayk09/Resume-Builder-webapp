  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <input onChange={(e)=>setNewSkill(e.target.value)}  value={newSkill}  onKeyDown={handleKeyPress}  type="text" placeholder='Enter a skill (e.g., JavaScript, Project Management)' className=' w-full flex px-3 py-2 text-sm' />
