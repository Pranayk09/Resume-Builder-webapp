import { FilePenLineIcon, LoaderCircleIcon, PencilIcon, PlusIcon, TrashIcon, UploadCloud,UploadIcon, XIcon } from 'lucide-react'
  ...
  {allResumes.map((resume, index) => {
    ...
    return (
      <button
        ...
        className="
          group relative w-full sm:max-w-36 h-48
          flex flex-col items-center justify-center
          rounded-lg gap-2 border
